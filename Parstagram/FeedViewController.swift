...
class FeedViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let center = NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillBeHidden(note:)), name: UIResponder.keyboardWillHideNotification, object: nil)
    }
...
extension FeedViewController: MessageInputBarDelegate {
    func messageInputBar(_ inputBar: MessageInputBar, didPressSendButtonWith text: String) {
        // Create the comment
        if commentBar.inputTextView.text != nil {
            let comment = PFObject(className: "Comments")
            comment["text"] = text
